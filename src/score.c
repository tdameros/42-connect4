...
static uint32_t calculate_score_vertically(board_t *board, uint32_t x,
                                           uint32_t y);
static uint32_t calculate_score_diagonally_right(board_t *board, uint32_t x,
                                                 uint32_t y);
static uint32_t calculate_score_diagonally_left(board_t *board, uint32_t x,
                                                uint32_t y);

uint32_t get_position_score(board_t *board, uint32_t x, uint32_t y) {
  return (calculate_score_horizontally(board, x, y) +
          calculate_score_vertically(board, x, y) +
          calculate_score_diagonally_left(board, x, y) +
          calculate_score_diagonally_right(board, x, y));
}
